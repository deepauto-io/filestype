...
func DetectFileType(filename string, data []byte) string {
	...
	mmType := extractMimeType(mm.String())

	switch mmType {
	case "application/vnd.openxmlformats-officedocument.presentationml.presentation": // 支持
		return mmType
	case "application/vnd.openxmlformats-officedocument.wordprocessingml.document": //  支持
		return mmType
	...
	case "application/javascript":
		return "text/javascript" // 支持
	case "text/x-python":
		return "text/x-script.python" // 支持
	case "application/msword": // 支持
		return mmType
	//case "text/x-tex":
	//	return mmType
	//case "application/x-latext":
	//	return mmType
	//case "text/x-java":
	//	return mmType
	//case "text/markdown":
...
// extractMimeType extracts the base mime type from a mime type string.
func extractMimeType(rawMimeType string) string {
	parts := strings.Split(rawMimeType, ";")
	baseMimeType := parts[0]
	return strings.TrimSpace(baseMimeType)
}
